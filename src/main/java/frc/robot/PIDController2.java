...
public class PIDController2 implements Sendable, AutoCloseable {
  ...
  public boolean atSetpoint() {
    ...
    System.out.println(m_haveMeasurement);
    System.out.println(m_haveSetpoint);
    System.out.println(Math.abs(m_positionError) < m_positionTolerance);
    System.out.println(Math.abs(m_velocityError) < m_velocityTolerance);
