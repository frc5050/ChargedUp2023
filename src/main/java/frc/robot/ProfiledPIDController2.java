...
public class ProfiledPIDController2 implements Sendable {
  ...
  private PIDController2 m_controller;
  ...
  public ProfiledPIDController2(
    ...
    m_controller = new PIDController2(Kp, Ki, Kd, period);
  ...
  public boolean atGoal() {
    ...
    System.out.println("m_goal.equals(m_setpoint): " + m_goal.equals(m_setpoint));
